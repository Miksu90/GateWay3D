...
void createShaderFiles() {
    ...
    if (vShader.is_open()) {
        ...
        vShader.close();
              ...
              // Fragment shader with area light
            ...
            if (fShader.is_open()) {
                ...
                fShader << "uniform bool areaLightActive;\n";
                fShader << "uniform vec3 areaLightPos;\n";
                fShader << "uniform vec3 areaLightColor;\n";
                fShader << "uniform float areaLightIntensity;\n";
                fShader << "uniform float areaLightRadius;\n\n";
...
glEnable(GL_DEPTH_TEST);
    ...
    Model dogModel("Models/Dog/scene.gltf");  // New model
                ...
                while (!glfwWindowShouldClose(window)) {
                    ...
                    shader.setBool("areaLightActive", areaLight1.active);
                    shader.setVec3("areaLightPos", areaLight1.position);
                    shader.setVec3("areaLightColor", areaLight1.color);
                    shader.setFloat("areaLightIntensity", areaLight1.intensity);
                    shader.setFloat("areaLightRadius", areaLight1.radius);
...
//                                    // Set texture scaling appropriately
//                                    if (textureManager.isObject(texID)) {
//                                        // For objects, maintain 1:1 aspect ratio
//                                        shader.setVec2("textureScale", glm::vec2(1.0f, 1.0f));
//                                    } else {
...
//                                    }
                    ...
                    // ****************************Render dog Model ******************
                            ...
                            dogModelMatrix = glm::translate(dogModelMatrix, glm::vec3(14.0f, 0.6f, 10.0f));
