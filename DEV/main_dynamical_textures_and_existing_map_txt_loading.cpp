...
public:
    ...
    // Load a texture for a specific ID
        ...
        // Replace or modify this function in TextureManager
        //Bind textures
        void bindTexture(int textureID) {
            ...
            if (textures.find(textureID) != textures.end() && textures[textureID] != 0) {
                std::cout << "Binding texture ID: " << textureID << " with handle: " << textures[textureID] << std::endl;
                glBindTexture(GL_TEXTURE_2D, textures[textureID]);
            } else {
                // Bind a default texture or do nothing
                std::cout << "No texture found for ID: " << textureID << std::endl;
            }
        }
