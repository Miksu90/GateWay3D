...
void createShaderFiles() {
    // Vertex shader
        ...
        if (vShader.is_open()) {
            ...
            // Update fragment shader to support normal mapping and flashlight
            ...
            if (fShader.is_open()) {
                ...
                fShader << "            flashlightDiffuse = flashDiff * lightColor * intensity * flashlightIntensity;\n";
                fShader << "        }\n";
                fShader << "    }\n\n";
                ...
                fShader << "        }\n";
                fShader << "        result = (ambient + diffuse + flashlightDiffuse) * texColor;\n";
                fShader << "    } else {\n";
                fShader << "        result = (ambient + diffuse + flashlightDiffuse) * objectColor;\n";
                fShader << "    }\n\n";
...
glEnable(GL_DEPTH_TEST);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        //*Flash light
        // Convert cutoff angles to cosines for shader
       ...
       //************ THIS CAUSED THE COLLISION DETECTION TO NOT WORK, WE HAD 0,5 diffrence with the game world grid ***********
        ...
        // Set texture scaling (adjust these values to control texture repetition)
        ...
        // For other renderings, reset the texture scale to default
        ...
        // ******************Render ceiling *************************
                ...
                // Load ceiling texture (use ID 101 to differentiate from floor)
                ...
                // Set texture scaling if desired
